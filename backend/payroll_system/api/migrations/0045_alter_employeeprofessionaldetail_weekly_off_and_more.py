# Generated by Django 4.1.5 on 2023-07-08 04:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0044_alter_employeeprofessionaldetail_weekly_off'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='weekly_off',
            field=models.CharField(choices=[('no_off', 'No Off'), ('mon', 'Monday'), ('tue', 'Tuesday'), ('wed', 'Wednesday'), ('thu', 'Thursday'), ('fri', 'Friday'), ('sat', 'Saturday'), ('sun', 'Sunday')], default='sun', max_length=6),
        ),
