...
class SalaryOvertimeSheetSerializer(serializers.Serializer):
    ...
    month = serializers.IntegerField()
    year = serializers.IntegerField()
    report_type = serializers.ChoiceField(choices=["salary_sheet", "payslip", "overtime_sheet", "payment_sheet", "advance_report"])
...
class AttendanceReportsSerializer(serializers.Serializer):
    ...
    month = serializers.IntegerField()
    year = serializers.IntegerField()
    report_type = serializers.ChoiceField(choices=["present_report", "attendance_register", "form_14", "overtime_sheet_daily", "bonus_calculation_sheet", "bonus_form_c", "miss_punch"])
    class Meta:
        fields = ['employee_ids', "filters"]
