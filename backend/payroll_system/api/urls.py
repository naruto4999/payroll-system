...
from .views import OvertimePolicyListCreateAPIView, OvertimePolicyRetrieveUpdateAPIView
...
urlpatterns = [
    ...
    path('leave-opening', EmployeeLeaveOpeningCreateUpdateAPIView.as_view()),
    path('leave-closing-transfer', LeaveClosingTransferCreateUpdateAPIView.as_view()),
    ...
    path('generate-employee-strength-reports', EmployeeStrengthReportsCreateAPIView.as_view()),
    ...
    path('prepared-salaries/<int:company_id>/<int:employee_id>/<int:year>/<int:month>', EmployeeSalaryPreparedRetrieveAPIView.as_view()),
    ...
    path('employee-yearly-advance-taken-deducted/<int:company_id>/<int:year>', EmployeeYearlyAdvanceTakenDeductedAPIView.as_view()),
