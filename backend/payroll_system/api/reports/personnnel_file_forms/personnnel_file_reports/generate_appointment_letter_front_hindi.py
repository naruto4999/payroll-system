...
def generate_appointment_letter_front_hindi(report, default_cell_height, default_cell_height_for_heading, employee, left_margin, right_margin):
    ...
    report.cell(w=0, h=default_cell_height, text=f"ओवरटाइम कार्य कर्मचारी की स्वैच्छिक (Voluntary) पर आधारित होगा। प्रबंधन द्वारा किसी भी कर्मचारी को ओवरटाइम कार्य करने हेतु बाध्य नहीं किया जाएगा। ओवरटाइम", align="L", new_x="LEFT", new_y='NEXT', border=0)
    report.cell(w=0, h=default_cell_height, text=f"कार्य केवल आवश्यकता होने पर, कर्मचारी की सहमति से तथा प्रचलित श्रम कानूनों के अनुसार किया जाएगा एवं भुगतान किया जाएगा। |", align="L", new_x="LEFT", new_y='NEXT', border=0)
