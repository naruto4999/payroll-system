...
def generate_full_and_final_report(request_data, employee):
    ...
    full_and_final_report.cell(w=0, h=default_cell_height, text=f"जिसमें मेरा आज तक का अर्जित वेतन, छुट्टियों का पैसा, आज तक का बोनस, नोटिस के बदले वेतन, ग्रेच्यूटी, सेवा काल का हर्जाना इत्यादि शामिल है | इस रकम की प्राप्ति के पशचात अब कम्पनी की", new_x="LMARGIN", new_y='NEXT', align='L', border=0)
