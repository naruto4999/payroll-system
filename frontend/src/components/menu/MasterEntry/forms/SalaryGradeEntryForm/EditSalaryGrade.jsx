...
const EditSalaryGrade = ({
	...
	return (
		<div className="text-gray-900 dark:text-slate-100">
			<h1 className="mb-2 text-2xl font-medium">Edit Salary Grade</h1>
			...
			<section className="mt-4 mb-2 flex flex-row gap-4">
				...
				<button
					...
					onClick={() => editSalaryGradePopoverHandler({ id: '' })}
				>
					Cancel
				</button>
			</section>
