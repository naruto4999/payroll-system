        ...
        <div className="text-gray-900 dark:text-slate-100">
            ...
            >
                ...
                <div className="relative">
                    <input
                        className={disableEdit ? classNames("dark:text-slate-100 text-gray-900 text-opacity-50 dark:text-opacity-50  border-gray-800 dark:border-slate-100 border-opacity-25 dark:border-opacity-25 rounded bg-opacity-50 bg-zinc-50 dark:bg-zinc-700  border-2 p-1 outline-none focus:border-opacity-100 dark:focus:border-opacity-75 transition w-full") :(classNames(
                ...
                <section className="flex flex-row gap-4 mt-4 mb-2">
                    ...
                    <button
                        ...
                        onClick={() => editLeaveGradePopoverHandler({ id: "", mandatory_leave: false })}
                    >
                        Cancel
                    </button>
                </section>
