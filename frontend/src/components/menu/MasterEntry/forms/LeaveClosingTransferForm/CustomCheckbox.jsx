...
const CustomCheckbox = ({ value, name, checked, onChange, disabled, borderColor = "border-slate-300", checkColor = "text-slate-300", height = "h-6", width = "w-6", checkSize = "text-sm", bgColor = "bg-transparent", borderSize = "border" }) => {
  return (
    <>
