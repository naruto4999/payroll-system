...
const AddEarningsHead = ({
    ...
    return (
        <div className="text-gray-900 dark:text-slate-100">
            <h1 className="font-medium text-2xl mb-2">Add Earnings Head</h1>
            ...
            >
                ...
                <div className="relative">
                    <input
                        ...
                        type="text"
                        id="earningsHeadName"
                        name="earningsHeadName"
                        onChange={handleChange}
                        onBlur={handleBlur}
                        value={values.earningsHeadName}
                        ref={inputRef}
                    />
                    {errors.earningsHeadName && (
                ...
                <section className="flex flex-row gap-4 mt-4 mb-2">
                    ...
                    <button
                        ...
                        onClick={() => {
                            setAddEarningsHeadPopover(false);
                            setErrorMessage("");
                        }}
                    >
                        Cancel
...
export default AddEarningsHead;
