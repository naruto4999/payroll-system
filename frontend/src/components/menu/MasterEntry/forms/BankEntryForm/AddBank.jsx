...
const AddBank = ({ handleSubmit, handleChange, handleBlur, values, errors, setAddBankPopover, isValid }) => {
        ...
        <div className="text-gray-900 dark:text-slate-100">
            ...
            <form action="" className="flex flex-col gap-2 justify-center" onSubmit={handleSubmit}>
                ...
                <div className="relative">
                    ...
                    />
                    {isValid ? "" :<p className="mt-1 text-xs dark:text-red-700 text-red-500 font-bold">{errors.newBank}</p>}
                </div>
            </form>
