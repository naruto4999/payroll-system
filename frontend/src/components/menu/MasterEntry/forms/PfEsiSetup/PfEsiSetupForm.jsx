...
const PfEsiSetupForm = () => {
	...
	useEffect(() => {
		setShowLoadingBar(
			isLoading || isAddingPfEsiSetup || isUpdatingPfEsiSetup || isLoading
		);
				...
				<div className="flex flex-row flex-wrap place-content-between">
					<div className="mr-4">
						...
						<p className="my-2 text-sm">
							Edit the values for PF and ESI calculations here
						</p>
					...
					initialValues={
						isSuccess
							? {
									...pfEsiSetup,
									employerPfCode:
										pfEsiSetup.employerPfCode ?? '',
									employerEsiCode:
										pfEsiSetup.employerEsiCode ?? '',
							  }
							: {
							...
							<section className="flex flex-col gap-2">
									...
									<div className="relative ">
										<Field
											className={classNames(
												errors.employerPfCode &&
													touched.employerPfCode
									...
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div>
											<div className="relative ">
												<Field
													className={classNames(
														errors.ac1EpfEmployeeLimit &&
															touched.ac1EpfEmployeeLimit
															? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
															: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
														'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
													)}
									...
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div>
											<div className="relative ">
												<Field
													className={classNames(
														errors.ac1EpfEmployerLimit &&
															touched.ac1EpfEmployerLimit
															? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
															: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
														'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
													)}
									...
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div>
											<div className="relative ">
												<Field
													className={classNames(
														errors.ac10EpsEmployerLimit &&
															touched.ac10EpsEmployerLimit
															? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
															: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
														'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
													)}
								...
								<div>
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div className="relative ">
											<Field
												className={classNames(
													errors.ac2EmployerPercentage &&
														touched.ac2EmployerPercentage
														? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
														: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
													'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
												)}
								...
								<div>
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div className="relative ">
											<Field
												className={classNames(
													errors.ac21EmployerPercentage &&
														touched.ac21EmployerPercentage
														? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
														: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
													'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
												)}
								...
								<div>
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div className="relative ">
											<Field
												className={classNames(
													errors.ac22EmployerPercentage &&
														touched.ac22EmployerPercentage
														? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
														: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
													'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
												)}
								...
								<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
									...
									<div className="relative ">
										<Field
											className={classNames(
												errors.employerEsiCode &&
													touched.employerEsiCode
													? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
													: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
												'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
											)}
								...
								<div>
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div className="relative ">
											<Field
												className={classNames(
													errors.esiEmployeePercentage &&
														touched.esiEmployeePercentage
														? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
														: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
													'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
												)}
										...
										<div>
											<div className="relative ">
												<Field
													className={classNames(
														errors.esiEmployeeLimit &&
															touched.esiEmployeeLimit
															? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
															: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
														'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
													)}
								...
								<div>
									<div className="flex w-fit flex-row flex-wrap gap-3 rounded border px-2 pt-5 pb-2 dark:border-slate-300 dark:border-opacity-20 dark:focus-within:border-opacity-60">
										...
										<div className="relative ">
											<Field
												className={classNames(
													errors.esiEmployerPercentage &&
														touched.esiEmployerPercentage
														? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
														: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
													'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
												)}
										...
										<div>
											<div className="relative ">
												<Field
													className={classNames(
														errors.esiEmployerLimit &&
															touched.esiEmployerLimit
															? 'border-red-500 border-opacity-100 dark:border-red-700 dark:border-opacity-75'
															: 'border-gray-800 border-opacity-25 dark:border-slate-100 dark:border-opacity-25',
														'custom-number-input peer w-full rounded border-2 bg-transparent p-1 outline-none transition focus:border-opacity-100 dark:focus:border-opacity-75'
													)}
