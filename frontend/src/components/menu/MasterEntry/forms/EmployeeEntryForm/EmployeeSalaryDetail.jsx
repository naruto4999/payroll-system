              ...
              {(!isEditing || !isSingleEmployeeSalaryDetailSuccess) &&
                <div>
                  ...
                  <div className='flex flex-row justify-between'>
                    <p className='text-base font-medium text-black text-opacity-100 dark:text-white dark:text-opacity-70'>Total</p>
                    <p className='text-base font-bold text-black text-opacity-100 dark:text-green-600'>{Object.values(values.earningsHead).reduce((sum, value) => sum + (parseFloat(value) || 0), 0)}</p>
                  </div>
                </div>
              }
