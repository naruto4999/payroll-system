...
const EmployeeTable = ({ table, flexRender }) => {
  return (
    <div className="scrollbar mx-auto max-h-[80dvh] max-w-7xl overflow-y-auto rounded border border-black border-opacity-50 shadow-md lg:max-h-[82dvh]">
          ...
          {table.getRowModel().rows.map((row) => (
            ...
            >
              {row.getVisibleCells().map((cell) => (
                <td className="px-4 py-3 font-normal" key={cell.id}>
