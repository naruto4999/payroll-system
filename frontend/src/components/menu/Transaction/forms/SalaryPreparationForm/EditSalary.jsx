          ...
          <div className="w-full">
            <table className="w-full border-collapse text-center text-xs">
              ...
              <tbody className="max-h-20 divide-y divide-black divide-opacity-50 overflow-y-auto border-t border-black border-opacity-50 ">
                ...
                <tr>
                  <td className="relative  text-orange-500 px-4 py-2 font-medium">
                    Total
                  </td>
                  <td className="relative  text-orange-500 px-4 py-2 font-medium">
                  ...
                  <td className="relative  text-orange-500 px-4 py-2 font-medium">
                    {values.earnedAmount?.reduce((total, earning) => {
                      if (earning.arearAmount != '' && earning.arearAmount != null && earning.arearAmount != undefined) {
                  ...
                  <td className="relative  text-orange-500 px-4 py-2 font-medium">
                    {values.earnedAmount?.reduce((total, earning) => total + (earning.earnedAmount), 0)}
                  </td>
                </tr>
              </tbody>
            </table>
