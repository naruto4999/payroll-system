...
{/* 
  We are dividing the elEncashmentDays by 2 in the apiSlice query and also multipling it by 2 
...
const FullAndFinal = ({
  ...
  const {
    data: employeeFullAndFinal, //elEncashmentDays are already divided by 2 so multiply by 2 before posting
