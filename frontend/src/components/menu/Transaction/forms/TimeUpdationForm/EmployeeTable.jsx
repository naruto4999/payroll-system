				...
				<table className="w-full border-collapse text-center text-xs">
					...
					>
						{table.getRowModel().rows.map((row) => (
							...
							>
								{/* {console.log(memoizedSelectedDate > new Date(row.original.dateOfJoining))}
								{row.original.resignationDate &&
									console.log(
										row.original.id,
										memoizedSelectedDate < new Date(row.original.resignationDate)
									)} */}

								{/* {memoizedSelectedDate > new Date(row.original.dateOfJoining) &&
									(!row.original.resignationDate ||
										(row.original.resignationDate &&
											memoizedSelectedDate < new Date(row.original.resignationDate))) && */}
