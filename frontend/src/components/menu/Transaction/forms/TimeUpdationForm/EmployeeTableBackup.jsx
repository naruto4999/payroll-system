		...
		<div className="py-2">
			<div className="scrollbar mx-auto max-h-[30dvh] max-w-full overflow-y-auto rounded border border-black border-opacity-50 shadow-md lg:max-h-[30dvh]">
				<table className="w-full border-collapse text-center text-xs">
					<thead className="sticky top-0 z-0 bg-blueAccent-600 dark:bg-blueAccent-700">
					...
					<tbody
						ref={tbodyRef}
						className="h-full divide-y divide-black divide-opacity-50 overflow-y-auto border-t border-black border-opacity-50 "
					>
