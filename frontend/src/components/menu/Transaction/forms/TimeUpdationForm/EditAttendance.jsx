...
import { ConfirmationModalSchema, DirectMachineAttendanceSchema, MdbMachineAttendanceSchema } from './TimeUpdationSchema';
import {
...
const EditAttendance = ({
  ...
  const { values, errors, touched, handleChange, handleSubmit, setFieldValue, isSubmitting, isValid } = useFormikContext();
  ...
  useEffect(() => {
    console.log('Edit Attendance renrendering')
  }, [])
  const categorizedAllEmployeeAttendance = useMemo(() => {
    if (allEmployeeAttendance) {
      const result = {};
  ...
  return (
    <>
      ...
      <form action="" className="w-fit" onSubmit={handleSubmit}>
        ...
        {document.getElementById("buttons-portal-destination") != null && (ReactDOM.createPortal(<>
          <div>
            <label
              htmlFor="year"
        ...
        {document.getElementById("update-buttons-portal-destination") != null && (ReactDOM.createPortal(
          <>
            <button
              className={classNames(
      ...
      <ReactModal
        ...
        onRequestClose={() =>
          setShowMdbMachineAttendanceModal(false || isAddingMachineAttendance)
        }
        style={{
          overlay: {
            backgroundColor: 'rgba(0, 0, 0, 0.75)',
      ...
      <ReactModal
        ...
        onRequestClose={() =>
          setShowDirectMachineAttendanceModal(false || isAddingMachineAttendance)
        }
        style={{
          overlay: {
            backgroundColor: 'rgba(0, 0, 0, 0.75)',
