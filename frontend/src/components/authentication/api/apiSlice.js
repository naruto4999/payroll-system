...
export const apiSlice = createApi({
    ...
    tagTypes: ["Departments", "Companies", "CompanyDetails", "Regular","SalaryGrades", "Categories", "Banks", "LeaveGrades", "Shifts", "Holidays", "EarningsHeads", "DeductionsHeads", "EmployeePersonalDetails", "EmployeeProfessionalDetails", "SingleEmployeeSalaryEarning", "EmployeeProfessionalDetails", "EmployeeSalaryDetails", "EmployeePfEsiDetails", "EmployeeFamilyNomineeDetails", "PfEsiSetup"],
    endpoints: (builder) => ({}),
});
